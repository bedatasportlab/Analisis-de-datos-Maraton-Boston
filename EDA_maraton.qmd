...
De este resumen s puede resaltar que: 
...
Una vez identificados los datos nulos ocultos de la variable *Nombre*, se va a proseguir con la variable *Nacionalidad*, como bien se ha detectado en @sec-deteccion-problemas, esta variable toma valores "-" que corresponden a corredores a los que les falta el dato de la nacionalidad. Es una buena práctica modificar este valor para tener identificados los datos nulos correspondientes a esta variable: 
